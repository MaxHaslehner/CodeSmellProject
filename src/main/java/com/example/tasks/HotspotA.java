...
public class HotspotA {
    ...
    // GENERATED SMELL 16 - duplicated prints, magic numbers, unused vars
    public void smellyMethod16() {
        int unused = 123; // unused variable
        for (int x = 0; x < 5; x++) {
            if (x % 2 == 0) {
                System.out.println("Magic: " + 42); // magic number
    ...
    // GENERATED SMELL 19 - duplicated prints, magic numbers, unused vars
    public void smellyMethod19() {
        int unused = 123; // unused variable
        for (int x = 0; x < 5; x++) {
            if (x % 2 == 0) {
                System.out.println("Magic: " + 42); // magic number
