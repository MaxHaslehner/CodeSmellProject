...
public class HotspotC {
    ...
    // GENERATED SMELL 12 - duplicated prints, magic numbers, unused vars
    public void smellyMethod12() {
        int unused = 123; // unused variable
        for (int x = 0; x < 5; x++) {
            if (x % 2 == 0) {
                System.out.println("Magic: " + 42); // magic number
    ...
    // GENERATED SMELL 15 - duplicated prints, magic numbers, unused vars
    public void smellyMethod15() {
        int unused = 123; // unused variable
        for (int x = 0; x < 5; x++) {
            if (x % 2 == 0) {
                System.out.println("Magic: " + 42); // magic number
    ...
    // GENERATED SMELL 18 - duplicated prints, magic numbers, unused vars
    public void smellyMethod18() {
        int unused = 123; // unused variable
        for (int x = 0; x < 5; x++) {
            if (x % 2 == 0) {
                System.out.println("Magic: " + 42); // magic number
